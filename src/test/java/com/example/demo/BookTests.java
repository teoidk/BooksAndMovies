...
//
//        BookDto bookDto = new BookDto(1L, "New Book", "New Author", "New Type", new ArrayList<>(), new ArrayList<>());
...
//        when(bookMapper.toDto(any(Book.class))).thenReturn(new BookDto(1L, "New Book", "New Author", "New Type", new ArrayList<>(), new ArrayList<>());
//
...
//
//        mockMvc.perform(MockServerHttpRequest.get("/books/1/ratings")
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isOk())
